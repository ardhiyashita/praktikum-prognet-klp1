                            ...
                            <div class="col-md-4 offset-md-4">
                                <form action="{{  url('admin/kategori/'.$kategori->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category_name" class="form-control @error('category_name') is-invalid @enderror" value="{{ old('category_name', $kategori->category_name) }}" autofocus>
                                        @error('category_name')
